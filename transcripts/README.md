...
GitHub 网页直接打开超长 Markdown 容易卡死。请按下面方式使用：

## 推荐方式（不会卡）

1. **下载压缩包**到电脑，解压后用记事本 / Word / WPS 打开里面的 `.txt` 文件：
...
- [05-The-Sacrificed-Witch-献祭女巫.zip](./05-The-Sacrificed-Witch-献祭女巫.zip)
...
| `05-The-Sacrificed-Witch-献祭女巫/` | [YouTube yvzOfjA-4eE](https://www.youtube.com/watch?v=yvzOfjA-4eE) | 中英双语完整 txt + 分卷 md（按对白编号，无时间轴） |

每个文件夹内：

- `01-完整-中英双语.txt` — **首选**，本机打开
- `02-完整-中文.txt` / `03-完整-英文.txt`
- `part01-….md` … — 分卷预览（每卷约 45 段，网页可打开）

旧的大体积单文件已移入 `_archive-old-large-files/`（请勿在网页预览）。
